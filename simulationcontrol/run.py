...
def eval_seg7():
    for benchmark in (
        ...
        runlib.run(['open', 'ttsp','exact', '20000000'], runlib.get_instance(benchmark, parallelism=4, input_set='simsmall')
                +','+ runlib.get_instance(benchmark, parallelism=4, input_set='simsmall')
                +','+ runlib.get_instance(benchmark, parallelism=4, input_set='simsmall')
                +','+ runlib.get_instance(benchmark, parallelism=4, input_set='simsmall')
                ) 
        # runlib.run(['open', 'tsp','exact', '20000000'], runlib.get_instance(benchmark, parallelism=4, input_set='small')
        #         +','+ runlib.get_instance(benchmark, parallelism=4, input_set='small')
        #         +','+ runlib.get_instance(benchmark, parallelism=4, input_set='small')
        #         +','+ runlib.get_instance(benchmark, parallelism=4, input_set='small')
        #         ) 
        # runlib.run(['open', 'ondemand','exact', '20000000'], runlib.get_instance(benchmark, parallelism=4, input_set='small')
        #         +','+ runlib.get_instance(benchmark, parallelism=4, input_set='small')
        #         +','+ runlib.get_instance(benchmark, parallelism=4, input_set='small')
        #         +','+ runlib.get_instance(benchmark, parallelism=4, input_set='small')
        #         ) 
    #runlib.run(['open', 'ttsp','exact', '5000000'], runlib.get_instance('splash2-radix', parallelism=16, input_set='small')) 
...
def case_study():
    runlib.run(['open', 'ttsp','exact', '1000000'], runlib.get_instance('parsec-blackscholes', parallelism=2, input_set='simsmall')) 
